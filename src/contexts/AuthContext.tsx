...
interface AuthContextType {
  ...
  signup: (email: string, password: string, displayName: string, role: UserRole, coachId?: string, subscriptionTier?: string, phoneNumber?: string, team?: string, age?: number, ageCategory?: string) => Promise<{ error?: string }>;
  logout: () => Promise<void>;
